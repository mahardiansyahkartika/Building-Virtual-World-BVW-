...
/// </summary>
public class PicBoardCtrl : MonoBehaviour {
	...
	void Start () {
		...
		float naLength = SoundFXCtrl.instance.PlaySound(curIndex, 1);
		transferSpeed = naLength + Time.time + 1;
	}
