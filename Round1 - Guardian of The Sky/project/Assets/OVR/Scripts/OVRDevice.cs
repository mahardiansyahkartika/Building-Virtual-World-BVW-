...
public class OVRDevice : MonoBehaviour 
{
	...
	// Turn off/on the initial Health & Safety warning automatically
	public static bool DismissHSWDisplay = true; 
	...
	void Update()
	{
		if (HMD != null && (Input.anyKeyDown || DismissHSWDisplay) && HMD.GetHSWDisplayState().Displayed)
